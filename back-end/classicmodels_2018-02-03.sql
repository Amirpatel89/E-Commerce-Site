...
# Generation Time: 2018-02-03 19:34:41 +0000
# ************************************************************
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `UserToCart` (`uid`),
  KEY `CartToProduct` (`productCode`),
  CONSTRAINT `CartToProduct` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`),
  CONSTRAINT `UserToCart` FOREIGN KEY (`uid`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `cart` WRITE;
/*!40000 ALTER TABLE `cart` DISABLE KEYS */;

INSERT INTO `cart` (`id`, `uid`, `productCode`)
VALUES
	(4,1,'S10_1678');
...
CREATE TABLE `customers` (
  ...
  `contactLastName` varchar(50) DEFAULT '',
  `contactFirstName` varchar(50) DEFAULT '',
...
VALUES
	...
	(497,'amir','','','','',NULL,'amir','amir',NULL,'',1337,100000.00),
	(498,'Amir','','','','',NULL,'amir','amir',NULL,'',1337,100000.00);
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`)
VALUES
	(10100,'2003-01-06','2003-01-13','2003-01-10','Shipped',NULL),
	(10101,'2003-01-09','2003-01-18','2003-01-11','Shipped','Check on availability.'),
	(10102,'2003-01-10','2003-01-18','2003-01-14','Shipped',NULL),
	(10103,'2003-01-29','2003-02-07','2003-02-02','Shipped',NULL),
	(10104,'2003-01-31','2003-02-09','2003-02-01','Shipped',NULL),
	(10105,'2003-02-11','2003-02-21','2003-02-12','Shipped',NULL),
	(10106,'2003-02-17','2003-02-24','2003-02-21','Shipped',NULL),
	(10107,'2003-02-24','2003-03-03','2003-02-26','Shipped','Difficult to negotiate with customer. We need more marketing materials'),
	(10108,'2003-03-03','2003-03-12','2003-03-08','Shipped',NULL),
	(10109,'2003-03-10','2003-03-19','2003-03-11','Shipped','Customer requested that FedEx Ground is used for this shipping'),
	(10110,'2003-03-18','2003-03-24','2003-03-20','Shipped',NULL),
	(10111,'2003-03-25','2003-03-31','2003-03-30','Shipped',NULL),
	(10112,'2003-03-24','2003-04-03','2003-03-29','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment'),
	(10113,'2003-03-26','2003-04-02','2003-03-27','Shipped',NULL),
	(10114,'2003-04-01','2003-04-07','2003-04-02','Shipped',NULL),
	(10115,'2003-04-04','2003-04-12','2003-04-07','Shipped',NULL),
	(10116,'2003-04-11','2003-04-19','2003-04-13','Shipped',NULL),
	(10117,'2003-04-16','2003-04-24','2003-04-17','Shipped',NULL),
	(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP'),
	(10119,'2003-04-28','2003-05-05','2003-05-02','Shipped',NULL),
	(10120,'2003-04-29','2003-05-08','2003-05-01','Shipped',NULL),
	(10121,'2003-05-07','2003-05-13','2003-05-13','Shipped',NULL),
	(10122,'2003-05-08','2003-05-16','2003-05-13','Shipped',NULL),
	(10123,'2003-05-20','2003-05-29','2003-05-22','Shipped',NULL),
	(10124,'2003-05-21','2003-05-29','2003-05-25','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch'),
	(10125,'2003-05-21','2003-05-27','2003-05-24','Shipped',NULL),
	(10126,'2003-05-28','2003-06-07','2003-06-02','Shipped',NULL),
	(10127,'2003-06-03','2003-06-09','2003-06-06','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse'),
	(10128,'2003-06-06','2003-06-12','2003-06-11','Shipped',NULL),
	(10129,'2003-06-12','2003-06-18','2003-06-14','Shipped',NULL),
	(10130,'2003-06-16','2003-06-24','2003-06-21','Shipped',NULL),
	(10131,'2003-06-16','2003-06-25','2003-06-21','Shipped',NULL),
	(10132,'2003-06-25','2003-07-01','2003-06-28','Shipped',NULL),
	(10133,'2003-06-27','2003-07-04','2003-07-03','Shipped',NULL),
	(10134,'2003-07-01','2003-07-10','2003-07-05','Shipped',NULL),
	(10135,'2003-07-02','2003-07-12','2003-07-03','Shipped',NULL),
	(10136,'2003-07-04','2003-07-14','2003-07-06','Shipped','Customer is interested in buying more Ferrari models'),
	(10137,'2003-07-10','2003-07-20','2003-07-14','Shipped',NULL),
	(10138,'2003-07-07','2003-07-16','2003-07-13','Shipped',NULL),
	(10139,'2003-07-16','2003-07-23','2003-07-21','Shipped',NULL),
	(10140,'2003-07-24','2003-08-02','2003-07-30','Shipped',NULL),
	(10141,'2003-08-01','2003-08-09','2003-08-04','Shipped',NULL),
	(10142,'2003-08-08','2003-08-16','2003-08-13','Shipped',NULL),
	(10143,'2003-08-10','2003-08-18','2003-08-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?'),
	(10144,'2003-08-13','2003-08-21','2003-08-14','Shipped',NULL),
	(10145,'2003-08-25','2003-09-02','2003-08-31','Shipped',NULL),
	(10146,'2003-09-03','2003-09-13','2003-09-06','Shipped',NULL),
	(10147,'2003-09-05','2003-09-12','2003-09-09','Shipped',NULL),
	(10148,'2003-09-11','2003-09-21','2003-09-15','Shipped','They want to reevaluate their terms agreement with Finance.'),
	(10149,'2003-09-12','2003-09-18','2003-09-17','Shipped',NULL),
	(10150,'2003-09-19','2003-09-27','2003-09-21','Shipped','They want to reevaluate their terms agreement with Finance.'),
	(10151,'2003-09-21','2003-09-30','2003-09-24','Shipped',NULL),
	(10152,'2003-09-25','2003-10-03','2003-10-01','Shipped',NULL),
	(10153,'2003-09-28','2003-10-05','2003-10-03','Shipped',NULL),
	(10154,'2003-10-02','2003-10-12','2003-10-08','Shipped',NULL),
	(10155,'2003-10-06','2003-10-13','2003-10-07','Shipped',NULL),
	(10156,'2003-10-08','2003-10-17','2003-10-11','Shipped',NULL),
	(10157,'2003-10-09','2003-10-15','2003-10-14','Shipped',NULL),
	(10158,'2003-10-10','2003-10-18','2003-10-15','Shipped',NULL),
	(10159,'2003-10-10','2003-10-19','2003-10-16','Shipped',NULL),
	(10160,'2003-10-11','2003-10-17','2003-10-17','Shipped',NULL),
	(10161,'2003-10-17','2003-10-25','2003-10-20','Shipped',NULL),
	(10162,'2003-10-18','2003-10-26','2003-10-19','Shipped',NULL),
	(10163,'2003-10-20','2003-10-27','2003-10-24','Shipped',NULL),
	(10164,'2003-10-21','2003-10-30','2003-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesn\'t like the colors and precision of the models.'),
	...
	(10166,'2003-10-21','2003-10-30','2003-10-27','Shipped',NULL),
	(10167,'2003-10-23','2003-10-30',NULL,'Cancelled','Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.'),
	(10168,'2003-10-28','2003-11-03','2003-11-01','Shipped',NULL),
	(10169,'2003-11-04','2003-11-14','2003-11-09','Shipped',NULL),
	(10170,'2003-11-04','2003-11-12','2003-11-07','Shipped',NULL),
	(10171,'2003-11-05','2003-11-13','2003-11-07','Shipped',NULL),
	(10172,'2003-11-05','2003-11-14','2003-11-11','Shipped',NULL),
	(10173,'2003-11-05','2003-11-15','2003-11-09','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches'),
	(10174,'2003-11-06','2003-11-15','2003-11-10','Shipped',NULL),
	(10175,'2003-11-06','2003-11-14','2003-11-09','Shipped',NULL),
	(10176,'2003-11-06','2003-11-15','2003-11-12','Shipped',NULL),
	(10177,'2003-11-07','2003-11-17','2003-11-12','Shipped',NULL),
	(10178,'2003-11-08','2003-11-16','2003-11-10','Shipped','Custom shipping instructions sent to warehouse'),
	(10179,'2003-11-11','2003-11-17','2003-11-13','Cancelled','Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.'),
	(10180,'2003-11-11','2003-11-19','2003-11-14','Shipped',NULL),
	(10181,'2003-11-12','2003-11-19','2003-11-15','Shipped',NULL),
	(10182,'2003-11-12','2003-11-21','2003-11-18','Shipped',NULL),
	(10183,'2003-11-13','2003-11-22','2003-11-15','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.'),
	(10184,'2003-11-14','2003-11-22','2003-11-20','Shipped',NULL),
	(10185,'2003-11-14','2003-11-21','2003-11-20','Shipped',NULL),
	(10186,'2003-11-14','2003-11-20','2003-11-18','Shipped','They want to reevaluate their terms agreement with the VP of Sales'),
	(10187,'2003-11-15','2003-11-24','2003-11-16','Shipped',NULL),
	(10188,'2003-11-18','2003-11-26','2003-11-24','Shipped',NULL),
	(10189,'2003-11-18','2003-11-25','2003-11-24','Shipped','They want to reevaluate their terms agreement with Finance.'),
	(10190,'2003-11-19','2003-11-29','2003-11-20','Shipped',NULL),
	(10191,'2003-11-20','2003-11-30','2003-11-24','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.'),
	(10192,'2003-11-20','2003-11-29','2003-11-25','Shipped',NULL),
	(10193,'2003-11-21','2003-11-28','2003-11-27','Shipped',NULL),
	(10194,'2003-11-25','2003-12-02','2003-11-26','Shipped',NULL),
	(10195,'2003-11-25','2003-12-01','2003-11-28','Shipped',NULL),
	(10196,'2003-11-26','2003-12-03','2003-12-01','Shipped',NULL),
	(10197,'2003-11-26','2003-12-02','2003-12-01','Shipped','Customer inquired about remote controlled models and gold models.'),
	(10198,'2003-11-27','2003-12-06','2003-12-03','Shipped',NULL),
	(10199,'2003-12-01','2003-12-10','2003-12-06','Shipped',NULL),
	(10200,'2003-12-01','2003-12-09','2003-12-06','Shipped',NULL),
	(10201,'2003-12-01','2003-12-11','2003-12-02','Shipped',NULL),
	(10202,'2003-12-02','2003-12-09','2003-12-06','Shipped',NULL),
	(10203,'2003-12-02','2003-12-11','2003-12-07','Shipped',NULL),
	(10204,'2003-12-02','2003-12-10','2003-12-04','Shipped',NULL),
	(10205,'2003-12-03','2003-12-09','2003-12-07','Shipped',' I need all the information I can get on our competitors.'),
	(10206,'2003-12-05','2003-12-13','2003-12-08','Shipped','Can we renegotiate this one?'),
	(10207,'2003-12-09','2003-12-17','2003-12-11','Shipped','Check on availability.'),
	(10208,'2004-01-02','2004-01-11','2004-01-04','Shipped',NULL),
	(10209,'2004-01-09','2004-01-15','2004-01-12','Shipped',NULL),
	(10210,'2004-01-12','2004-01-22','2004-01-20','Shipped',NULL),
	(10211,'2004-01-15','2004-01-25','2004-01-18','Shipped',NULL),
	(10212,'2004-01-16','2004-01-24','2004-01-18','Shipped',NULL),
	(10213,'2004-01-22','2004-01-28','2004-01-27','Shipped','Difficult to negotiate with customer. We need more marketing materials'),
	(10214,'2004-01-26','2004-02-04','2004-01-29','Shipped',NULL),
	(10215,'2004-01-29','2004-02-08','2004-02-01','Shipped','Customer requested that FedEx Ground is used for this shipping'),
	(10216,'2004-02-02','2004-02-10','2004-02-04','Shipped',NULL),
	(10217,'2004-02-04','2004-02-14','2004-02-06','Shipped',NULL),
	(10218,'2004-02-09','2004-02-16','2004-02-11','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment'),
	(10219,'2004-02-10','2004-02-17','2004-02-12','Shipped',NULL),
	(10220,'2004-02-12','2004-02-19','2004-02-16','Shipped',NULL),
	(10221,'2004-02-18','2004-02-26','2004-02-19','Shipped',NULL),
	(10222,'2004-02-19','2004-02-27','2004-02-20','Shipped',NULL),
	(10223,'2004-02-20','2004-02-29','2004-02-24','Shipped',NULL),
	(10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP'),
	(10225,'2004-02-22','2004-03-01','2004-02-24','Shipped',NULL),
	(10226,'2004-02-26','2004-03-06','2004-03-02','Shipped',NULL),
	(10227,'2004-03-02','2004-03-12','2004-03-08','Shipped',NULL),
	(10228,'2004-03-10','2004-03-18','2004-03-13','Shipped',NULL),
	(10229,'2004-03-11','2004-03-20','2004-03-12','Shipped',NULL),
	(10230,'2004-03-15','2004-03-24','2004-03-20','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch'),
	(10231,'2004-03-19','2004-03-26','2004-03-25','Shipped',NULL),
	(10232,'2004-03-20','2004-03-30','2004-03-25','Shipped',NULL),
	(10233,'2004-03-29','2004-04-04','2004-04-02','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse'),
	(10234,'2004-03-30','2004-04-05','2004-04-02','Shipped',NULL),
	(10235,'2004-04-02','2004-04-12','2004-04-06','Shipped',NULL),
	(10236,'2004-04-03','2004-04-11','2004-04-08','Shipped',NULL),
	(10237,'2004-04-05','2004-04-12','2004-04-10','Shipped',NULL),
	(10238,'2004-04-09','2004-04-16','2004-04-10','Shipped',NULL),
	(10239,'2004-04-12','2004-04-21','2004-04-17','Shipped',NULL),
	(10240,'2004-04-13','2004-04-20','2004-04-20','Shipped',NULL),
	(10241,'2004-04-13','2004-04-20','2004-04-19','Shipped',NULL),
	(10242,'2004-04-20','2004-04-28','2004-04-25','Shipped','Customer is interested in buying more Ferrari models'),
	(10243,'2004-04-26','2004-05-03','2004-04-28','Shipped',NULL),
	(10244,'2004-04-29','2004-05-09','2004-05-04','Shipped',NULL),
	(10245,'2004-05-04','2004-05-12','2004-05-09','Shipped',NULL),
	(10246,'2004-05-05','2004-05-13','2004-05-06','Shipped',NULL),
	(10247,'2004-05-05','2004-05-11','2004-05-08','Shipped',NULL),
	(10248,'2004-05-07','2004-05-14',NULL,'Cancelled','Order was mistakenly placed. The warehouse noticed the lack of documentation.'),
	(10249,'2004-05-08','2004-05-17','2004-05-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?'),
	(10250,'2004-05-11','2004-05-19','2004-05-15','Shipped',NULL),
	(10251,'2004-05-18','2004-05-24','2004-05-24','Shipped',NULL),
	(10252,'2004-05-26','2004-06-04','2004-05-29','Shipped',NULL),
	(10253,'2004-06-01','2004-06-09','2004-06-02','Cancelled','Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.'),
	(10254,'2004-06-03','2004-06-13','2004-06-04','Shipped','Customer requested that DHL is used for this shipping'),
	(10255,'2004-06-04','2004-06-12','2004-06-09','Shipped',NULL),
	(10256,'2004-06-08','2004-06-16','2004-06-10','Shipped',NULL),
	(10257,'2004-06-14','2004-06-24','2004-06-15','Shipped',NULL),
	(10258,'2004-06-15','2004-06-25','2004-06-23','Shipped',NULL),
	(10259,'2004-06-15','2004-06-22','2004-06-17','Shipped',NULL),
	(10260,'2004-06-16','2004-06-22',NULL,'Cancelled','Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.'),
	(10261,'2004-06-17','2004-06-25','2004-06-22','Shipped',NULL),
	(10262,'2004-06-24','2004-07-01',NULL,'Cancelled','This customer found a better offer from one of our competitors. Will call back to renegotiate.'),
	(10263,'2004-06-28','2004-07-04','2004-07-02','Shipped',NULL),
	(10264,'2004-06-30','2004-07-06','2004-07-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2004'),
	(10265,'2004-07-02','2004-07-09','2004-07-07','Shipped',NULL),
	(10266,'2004-07-06','2004-07-14','2004-07-10','Shipped',NULL),
	(10267,'2004-07-07','2004-07-17','2004-07-09','Shipped',NULL),
	(10268,'2004-07-12','2004-07-18','2004-07-14','Shipped',NULL),
	(10269,'2004-07-16','2004-07-22','2004-07-18','Shipped',NULL),
	(10270,'2004-07-19','2004-07-27','2004-07-24','Shipped','Can we renegotiate this one?'),
	(10271,'2004-07-20','2004-07-29','2004-07-23','Shipped',NULL),
	(10272,'2004-07-20','2004-07-26','2004-07-22','Shipped',NULL),
	(10273,'2004-07-21','2004-07-28','2004-07-22','Shipped',NULL),
	(10274,'2004-07-21','2004-07-29','2004-07-22','Shipped',NULL),
	(10275,'2004-07-23','2004-08-02','2004-07-29','Shipped',NULL),
	(10276,'2004-08-02','2004-08-11','2004-08-08','Shipped',NULL),
	(10277,'2004-08-04','2004-08-12','2004-08-05','Shipped',NULL),
	(10278,'2004-08-06','2004-08-16','2004-08-09','Shipped',NULL),
	(10279,'2004-08-09','2004-08-19','2004-08-15','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches'),
	(10280,'2004-08-17','2004-08-27','2004-08-19','Shipped',NULL),
	(10281,'2004-08-19','2004-08-28','2004-08-23','Shipped',NULL),
	(10282,'2004-08-20','2004-08-26','2004-08-22','Shipped',NULL),
	(10283,'2004-08-20','2004-08-30','2004-08-23','Shipped',NULL),
	(10284,'2004-08-21','2004-08-29','2004-08-26','Shipped','Custom shipping instructions sent to warehouse'),
	(10285,'2004-08-27','2004-09-04','2004-08-31','Shipped',NULL),
	(10286,'2004-08-28','2004-09-06','2004-09-01','Shipped',NULL),
	...
	(10328,'2004-11-12','2004-11-21','2004-11-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch'),
	...
	(10367,'2005-01-12','2005-01-21','2005-01-16','Resolved','This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.'),
	...
	(10377,'2005-02-09','2005-02-21','2005-02-12','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches'),
	...
	(10406,'2005-04-15','2005-04-25','2005-04-21','Disputed','Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.'),
	...
	(10415,'2005-05-09','2005-05-20','2005-05-12','Disputed','Customer claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise'),
...
VALUES
	('AB661578','2004-07-28',9415.13),
	('AD304085','2003-10-24',36798.88),
	('AD832091','2004-09-09',1960.80),
	('AE192287','2005-03-10',23602.90),
	('AE215433','2005-03-05',101244.59),
	('AF246722','2003-11-24',31428.21),
	('AF40894','2003-11-22',33818.34),
	('AG240323','2003-12-16',20220.04),
	('AH612904','2003-09-28',29997.09),
	('AJ478695','2005-02-14',33967.73),
	('AJ574927','2004-03-13',47375.92),
	('AK412714','2003-10-27',37602.48),
	('AL493079','2005-05-23',75020.13),
	('AM968797','2004-11-03',52825.29),
	('AO757239','2003-09-15',6631.36),
	('AP286625','2004-10-24',23333.06),
	('AU364101','2003-07-19',36251.03),
	('AU750837','2004-04-17',15183.63),
	('BC726082','2004-12-03',12081.52),
	('BF686658','2003-12-22',58793.53),
	('BG255406','2004-08-28',85410.87),
	('BG407567','2003-05-09',3101.40),
	('BH167026','2003-12-26',59265.14),
	('BI507030','2003-04-22',44380.15),
	('BJ483870','2004-12-05',37654.09),
	('BJ535230','2003-12-09',45480.79),
	('BJMPR4545','2005-04-23',12190.85),
	('BL66528','2004-04-14',5899.38),
	('BN17870','2005-03-02',3452.75),
	('BN347084','2003-12-02',20644.24),
	('BO711618','2004-10-03',17359.53),
	('BO864823','2004-12-17',14191.12),
	('BOAF82044','2005-05-03',35157.75),
	('BOFA23232','2005-05-20',29070.38),
	('BQ327613','2004-09-16',38785.48),
	('BQ39062','2004-12-08',47159.11),
	('BQ602907','2004-12-11',18888.31),
	('BR352384','2004-11-14',2434.25),
	('BR478494','2003-11-18',50743.65),
	('BR941480','2003-10-18',4465.85),
	('CA762595','2005-02-12',28322.83),
	('CC475233','2003-04-19',1627.56),
	('CC871084','2003-05-12',35826.33),
	('CE51751','2004-12-04',51209.58),
	('CI381435','2004-01-19',47177.59),
	('CI471510','2003-05-25',50824.66),
	('CITI3434344','2005-05-19',28500.78),
	('CL442705','2003-03-12',22292.62),
	('CM564612','2004-04-25',22602.36),
	('CN328545','2004-07-03',4710.73),
	('CO351193','2005-01-10',49705.52),
	('CO645196','2003-12-10',35505.63),
	('CP804873','2004-11-19',15822.84),
	('CQ287967','2003-04-11',11044.30),
	('CS435306','2005-01-27',45785.34),
	('CT821147','2004-08-01',6419.84),
	('DA98827','2003-11-28',34606.28),
	('DB583216','2004-11-01',36140.38),
	('DB889831','2003-02-16',50218.95),
	('DB933704','2004-11-14',19501.82),
	('DC979307','2004-07-07',44160.92),
	('DD635282','2004-08-11',2611.84),
	('DD995006','2004-11-15',33145.56),
	('DG336041','2005-02-15',46770.52),
	('DG700707','2004-01-18',21053.69),
	('DI925118','2003-01-28',10549.01),
	('DJ15149','2003-11-03',85559.12),
	('DL460618','2005-05-19',46895.48),
	('DM826140','2004-12-08',26248.78),
	('DO106109','2003-11-18',38524.29),
	('DO787644','2004-06-21',22037.91),
	('DP677013','2003-10-20',23908.24),
	('DQ409197','2004-12-13',13671.82),
	('DR578578','2004-10-28',47411.33),
	('ED203908','2005-04-15',30293.77),
	('ED39322','2004-04-26',28211.70),
	('ED473873','2003-11-15',27121.90),
	('ED520529','2004-06-21',4632.31),
	('ED743615','2004-09-19',12538.01),
	('ED878227','2003-07-21',13920.26),
	('EF485824','2004-06-21',59551.38),
	('EH208589','2003-04-20',33383.14),
	('EK785462','2003-03-09',51001.22),
	('EM979878','2005-02-09',27083.78),
	('EN930356','2004-04-16',7178.66),
	('EP227123','2004-02-10',5759.42),
	('EQ12267','2005-05-17',17928.09),
	('ER54537','2004-09-28',31310.09),
	('ER615123','2003-06-25',17032.29),
	('ES347491','2004-06-24',37281.36),
	('ET64396','2005-04-16',83598.04),
	('EU280955','2004-11-06',61234.67),
	('EU531600','2005-05-25',30253.75),
	('FA465482','2003-10-18',24101.81),
	('FA728475','2003-10-06',32723.04),
	('FD317790','2003-10-28',1491.38),
	('FH668230','2004-03-24',33820.62),
	('FI192930','2004-12-06',9658.74),
	('FN155234','2004-05-14',6276.60),
	('FN640986','2003-11-20',15130.97),
	('FP170292','2004-07-11',18473.71),
	('FP443161','2003-07-07',29429.14),
	('FP549817','2004-03-18',40978.53),
	('FR499138','2003-09-16',32680.31),
	('FS299615','2005-04-18',27966.54),
	('FU793410','2004-01-16',49614.72),
	('GB117430','2005-02-03',14379.90),
	('GB361972','2003-12-07',27988.47),
	('GB852215','2004-07-26',20314.44),
	('GB878038','2004-03-15',18997.89),
	('GB890854','2004-08-02',12530.51),
	('GC60330','2003-11-08',9977.85),
	('GC697638','2004-08-13',51152.86),
	('GG31455','2003-05-20',45864.03),
	('GH197075','2004-07-25',35034.57),
	('GJ597719','2005-01-18',8307.28),
	('GJ715659','2004-11-13',27550.51),
	('GK294076','2004-10-26',3474.66),
	('GL756480','2003-12-04',3879.96),
	('GN228846','2003-12-03',85024.46),
	('GP545698','2004-05-13',11843.45),
	('GP636783','2003-03-02',52151.81),
	('GQ132144','2003-01-30',5494.78),
	('GT878649','2003-05-21',16700.47),
	('HA777606','2003-12-05',38139.18),
	('HB150714','2003-11-23',37455.77),
	('HD284647','2004-12-30',26311.63),
	('HE84936','2004-10-22',53116.99),
	('HG438769','2004-07-18',51619.02),
	('HG635467','2005-05-03',8807.12),
	('HG738664','2003-07-05',2880.00),
	('HH517378','2003-08-16',29716.86),
	('HI358554','2003-12-18',36527.61),
	('HI366474','2004-12-27',47142.70),
	('HI618861','2004-11-19',35152.12),
	('HJ217687','2004-01-28',49165.16),
	('HJ32686','2004-01-30',59830.55),
	('HJ618252','2005-06-09',46656.94),
	('HL209210','2003-11-15',23936.53),
	('HL575273','2004-11-17',50799.69),
	('HL685576','2004-11-06',42339.76),
	('HN114306','2003-07-18',23419.47),
	('HO576374','2003-08-20',41016.75),
	('HQ336336','2004-10-19',6066.78),
	('HQ55022','2003-06-06',32641.98),
	('HQ920205','2003-07-06',6036.96),
	('HR182688','2004-12-01',20564.86),
	('HR224331','2005-06-03',12432.32),
	('HR86578','2004-11-02',55639.66),
	('HS86661','2004-11-23',45994.07),
	('IA793562','2003-08-03',24013.52),
	('ID10962','2004-12-31',116208.40),
	('ID449593','2003-12-11',23923.93),
	('IF245157','2004-11-16',46788.14),
	('IG462397','2004-03-29',20355.24),
	('II180006','2004-07-01',22997.45),
	('IJ399820','2004-09-19',33924.24),
	('IL104425','2003-11-22',42783.81),
	('IN446258','2005-03-25',65071.26),
	('IO164641','2004-08-30',37527.58),
	('IO448913','2003-11-19',24879.08),
	('IP383901','2004-11-18',7466.32),
	('IP568906','2003-06-18',58841.35),
	('IQ627690','2004-11-08',33594.58),
	('IR662429','2004-05-12',32239.47),
	('IR846303','2004-12-12',36005.71),
	('IS150005','2004-09-24',4424.40),
	('IS232033','2003-01-16',10223.83),
	('IS946883','2004-09-21',5858.56),
	('JB117768','2003-03-20',25833.14),
	('JE105477','2005-03-18',120166.58),
	('JG981190','2003-11-18',16909.84),
	('JH546765','2003-11-29',47513.19),
	('JJ246391','2003-02-20',53959.21),
	('JK479662','2003-10-17',9821.32),
	('JM555205','2003-06-05',14571.44),
	('JN355280','2003-10-26',49539.37),
	('JN722010','2003-02-25',40206.20),
	('JO719695','2004-03-28',24995.61),
	('JP113227','2003-12-09',7678.25),
	('JPMR4544','2005-05-18',615.45),
	('JT819493','2004-08-02',35806.73),
	('KA602407','2004-10-21',34341.08),
	('KB54275','2004-11-29',48927.64),
	('KF480160','2004-12-07',25505.98),
	('KG644125','2005-02-02',12692.19),
	('KH910279','2004-09-05',43134.04),
	('KI131716','2003-08-15',111654.40),
	('KI744716','2003-07-21',14232.70),
	('KI831359','2004-11-04',17876.32),
	('KI884577','2004-12-14',39964.63),
	('KL124726','2003-03-27',48425.69),
	('KM172879','2003-12-26',105743.00),
	('KM841847','2003-11-13',38547.19),
	('KR822727','2004-09-30',48809.90),
	('KT52578','2003-12-09',63843.55),
	('LA318629','2004-02-28',22474.17),
	('LA556321','2005-03-15',46781.66),
	('LA685678','2003-04-09',7674.94),
	('LE432182','2003-09-28',41554.73),
	('LF217299','2004-03-26',43369.30),
	('LF501133','2004-09-18',61402.00),
	('LF737277','2004-05-22',28394.54),
	('LG808674','2003-10-24',20452.50),
	('LJ160635','2003-12-10',39712.10),
	('LL427009','2004-02-17',7612.06),
	('LL562733','2003-09-05',50342.74),
	('LM271923','2003-04-16',21665.98),
	('LN373447','2004-08-08',47924.19),
	('LQ244073','2004-08-09',45352.47),
	('MA302151','2004-11-28',34638.14),
	('MA724562','2004-12-02',50025.35),
	('MA765515','2004-12-15',82261.22),
	('MB342426','2003-07-16',32077.44),
	('MC46946','2004-07-09',35420.74),
	('MD809704','2004-03-03',16901.38),
	('ME497970','2005-03-27',3516.04),
	('MF629602','2004-08-16',20009.53),
	('ML780814','2004-12-06',24945.21),
	('MM342086','2003-12-14',40473.86),
	('MN89921','2004-12-31',52166.00),
	('MO743231','2004-04-30',1679.92),
	('MQ413968','2003-10-31',36164.46),
	('MS154481','2003-08-22',1128.20),
	('MU817160','2003-11-24',52548.49),
	('NA197101','2004-06-17',25080.96),
	('NA377824','2004-02-06',22162.61),
	('NB291497','2004-05-15',36442.34),
	('NB445135','2004-09-11',35321.97),
	('ND748579','2004-08-20',33347.88),
	('NE404084','2004-09-04',48298.99),
	('NF959653','2005-03-01',21432.31),
	('NG94694','2005-02-22',49523.67),
	('NH776924','2004-04-24',29284.42),
	('NI908214','2003-08-05',38675.13),
	('NI983021','2003-11-24',37723.79),
	('NJ906924','2004-04-02',15322.93),
	('NM739638','2005-02-06',39580.60),
	('NM916675','2004-03-01',32538.74),
	('NN711988','2004-09-07',63357.13),
	('NP603840','2003-05-31',7565.08),
	('NQ865547','2004-03-15',80375.24),
	('NQ966143','2004-04-25',16212.59),
	('NR157385','2004-09-05',32260.16),
	('NR27552','2004-03-10',44894.74),
	('NR631421','2004-05-30',31102.85),
	('NT141748','2003-11-25',45084.38),
	('NU21326','2004-11-02',53745.34),
	('NU627706','2004-05-17',26155.91),
	('OA595449','2003-10-31',22042.37),
	('OB648482','2005-01-29',1834.56),
	('OC773849','2003-12-04',22275.73),
	('OD327378','2005-01-03',31835.36),
	('OG208861','2004-09-21',15059.76),
	('OH367219','2004-11-16',44400.50),
	('OJ819725','2005-04-30',29848.52),
	('OM314933','2004-12-18',1676.14),
	('OM548174','2003-12-07',36092.40),
	('OO606861','2003-06-13',57131.92),
	('OO846801','2004-06-15',37258.94),
	('OU516561','2004-12-17',26304.13),
	('PB951268','2004-02-13',36070.47),
	('PC688499','2003-10-27',17746.26),
	('PE176846','2004-11-27',48355.87),
	('PH29054','2004-11-27',42813.83),
	('PH785937','2004-05-04',36069.26),
	('PI15215','2004-07-10',42044.77),
	('PI42991','2003-04-09',16537.85),
	('PJ434867','2004-04-14',31670.37),
	('PN238558','2003-12-05',55425.77),
	('PO860906','2004-01-31',7310.42),
	('PQ803830','2004-12-24',39440.59),
	('PT550181','2004-02-29',12573.28);
...
VALUES
	('NES','Original Nintendo System.  Great Deals!',NULL,NULL),
	('Nintendo 64','Nintendo 64.  Great Deals!',NULL,NULL),
	('PS1','The original Playstation.  Great Deals!',NULL,NULL),
	('PS2 GC Xbox','Enjoy great deals on classic games.',NULL,NULL),
	('PS3 Xbox 360','Great Deals on last-gen games!',NULL,NULL),
	('PS4 XB1','Current Generation.  Find the lowest prices anywhere',NULL,NULL),
	('SNES Genesis','Super Nintendo and Sega Genesis.  Great Deals!',NULL,NULL);
...
INSERT INTO `products` (`productCode`, `productName`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `picture`, `productLine`)
VALUES
	('S10_1678','The Legend of Zelda','Nintendo','Gold cartridge edition.  Works great!',7933,48.81,'https://wiki.dolphin-emu.org/images/6/67/Zelda.jpg','NES'),
	('S10_1949','Playstation 4 - 1TB','Sony','Great Condition.  Low price!',7305,129.99,'https://media.playstation.com/is/image/SCEA/playstation-4-slim-vertical-product-shot-01-us-07sep16?$TwoColumn_Image$','PS4 XB1'),
	('S10_2016','Star Wars Battlefront 2 Deluxe','Sony','Deluxe Edition.  The force is strong with this one.',6625,68.99,'https://www.gamestop.com/common/images/lbox/146499b.jpg','PS4 XB1'),
	('S10_4698','Mario Is Missing','Nintendo','Your chance to collect the worst mario game ever! Giving this one away for free...',5582,0.00,'http://www.mobygames.com/images/covers/l/246802-mario-is-missing-nes-front-cover.png','NES'),
	('S10_4757','Nintendo 64 Console','Nintendo','Includes all cables, rumble pack, and expansion pack.  Black color with red remote.  Third controller port does not work.',3252,85.68,'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Nintendo-64-wController-L.jpg/300px-Nintendo-64-wController-L.jpg','Nintendo 64'),
	('S10_4962','Super Mario Bros.','Nintendo','Inclusion of Duck Hunt gun subject to local gun laws.',6791,103.42,'https://vignette.wikia.nocookie.net/nintendo/images/3/3d/Super_Mario_Bros._%28NA%29.png/revision/latest?cb=20120516222518&path-prefix=en','NES'),
	('S12_1099','Final Fantasy ','Nintendo','Decent Condition.  Picture quality appears pixelated',68,95.34,'https://upload.wikimedia.org/wikipedia/en/d/d8/FF1_USA_boxart.jpg','NES'),
	('S12_1108','Zelda: A Link to the Past','Nintendo','May have to blow on it a couple times to get it to work.',3619,95.59,'https://romsmania.com/statics/assets/covers/super-nintendo/18322front-7116.jpg','SNES Genesis'),
	('S12_1666','Star Fox','Nintendo','Good condition.  Do a barrel roll!',1579,77.90,'https://www.lukiegames.com/assets/images/SNES/snes_star_fox_p_p1j295.jpg','SNES Genesis'),
	('S12_2823','Sonic the Hedgehog 2','Sega','Does not work but cover is in great condition!',9997,66.27,'https://images-na.ssl-images-amazon.com/images/I/510JGxmJTkL._AC_SX215_.jpg','SNES Genesis'),
	('S12_3148','Mega Man','Nintendo','No sound',6906,89.14,'https://images-na.ssl-images-amazon.com/images/I/51q3sipgngL.jpg','NES'),
	('S12_3380','Super Mario World','Nintendo','Still works.  ',9123,75.16,'http://earnthis.net/wp-content/uploads/2014/01/super-mario-world-1.jpg','SNES Genesis'),
	('S12_3891','Pink Panther Goes to Hollywood','Sega','No cover included.  ',1049,83.05,'https://www.rock30games.com/ItemImages/Large/312000413.jpg','SNES Genesis'),
	('S12_3990','X-Men','Sega','Mint Condition',5663,31.92,'https://vignette.wikia.nocookie.net/thegameroom/images/f/f2/X-Men_Genesis_Box_Art.png/revision/latest?cb=20131216192154','SNES Genesis'),
	('S12_4473','Mortal Kombat','Nintendo','Works Great.  Get over here!',6125,55.70,'https://gamefaqs.akamaized.net/box/1/5/8/20158_front.jpg','SNES Genesis'),
	('S12_4675','Chrono Trigger','Nintendo','All endings included in game package.',7323,58.73,'https://romsmania.com/statics/assets/covers/super-nintendo/chrono-trigger-cover-snes-4429.jpg','SNES Genesis'),
	('S18_1097','Donkey Kong Country 2','Nintendo','No sticker on cartridge.  Works fine.',2613,58.33,'https://wiki.dolphin-emu.org/images/c/c3/DK_Country_2.jpg','SNES Genesis'),
	('S18_1342','Xbox One- 500GB','Microsoft','Slim Model',8693,60.62,'https://compass-ssl.xbox.com/assets/e8/07/e8078ec0-cc95-45c2-b273-1b0d67f8a96f.jpg?n=Xbox_Family_Image-0_X1S_496x279.jpg','PS4 XB1'),
	('S18_1367','Resident Evil 7: Biohazard','Microsoft','Not for kids.  Great Condition.',8635,24.26,'https://www.gamestop.com/common/images/lbox/127501b.jpg','PS4 XB1'),
	('S18_1662','Final Fantasy XV','Sony','Has a scratch but still works.  No booklet',5330,77.27,'https://images-na.ssl-images-amazon.com/images/I/91IQSCL7wtL._SX342_.jpg','PS4 XB1'),
	('S18_1749','NBA 2k17','Microsoft','Great Condition! Comes with a poster of Sam Cassell',2724,86.70,'https://www.gamestop.com/common/images/lbox/131010b1.jpg','PS4 XB1'),
	('S18_2248','Uncharted 4','Sony','Lowest Price in the World!',540,33.30,'https://pisces.bbystatic.com/image2/BestBuy_US/images/products/2943/2943094_sd.jpg;maxHeight=550;maxWidth=642','PS4 XB1'),
	('S18_2319','Witcher 3','Sony','Great Condition.  Does not include expansions.',8258,74.86,'https://upload.wikimedia.org/wikipedia/en/thumb/0/0c/Witcher_3_cover_art.jpg/220px-Witcher_3_cover_art.jpg','PS4 XB1'),
	('S18_2325','Galaga','Nintendo','Arcade Classic. Working Condition',9354,58.48,'http://img2.game-oldies.com/sites/default/files/packshots/nintendo-nes/galaga-demons-of-death-usa.png','NES'),
	('S18_2432','Destiny 2','Sony','Internet connection required for gameplay',2018,24.92,'https://www.gamestop.com/common/images/lbox/146358b.jpg','PS4 XB1'),
	('S18_2581','Grand Theft Auto V','Microsoft','Good Condition. Poster included',992,49.00,'https://www.gamestop.com/common/images/lbox/102047b.jpg','PS4 XB1'),
	('S18_2625','Horizon Zero Dawn','Sony','Day One Edition.  Mint condition',4357,24.23,'https://s3.thcdn.com/productimg/600/600/11136020-1084395691782066.jpg','PS4 XB1'),
	('S18_2795','Metal Gear Solid','Sony','Good condition but no cover.  Codec on back of cover given upon sale of item.',548,72.56,'https://upload.wikimedia.org/wikipedia/en/thumb/3/33/Metal_Gear_Solid_cover_art.png/220px-Metal_Gear_Solid_cover_art.png','PS1'),
	('S18_2949','Final Fantasy VII','Sony','Decent Condition. No booklet',4189,60.78,'https://upload.wikimedia.org/wikipedia/en/c/c2/Final_Fantasy_VII_Box_Art.jpg','PS1'),
	('S18_2957','Tony Hawk\'s Pro Skater 2','Sony','Works Great!',5649,34.35,'https://r.mprd.se/fup/up/52462-Tony_Hawk\'s_Pro_Skater_2_(E)-1.jpg','PS1'),
	('S18_3029','Final Fantasy X','Sony','Great Condition with Strategy Guide included for FREE!',4259,51.61,'https://r.mprd.se/fup/up/150559-Final_Fantasy_X_(USA)-1.jpg','PS2 GC Xbox'),
	('S18_3136','Halo: Combat Evolved','Microsoft','Working copy.  Does not play online',5992,60.74,'https://vignette.wikia.nocookie.net/halo/images/8/81/Halo_Combat_Evolved_-_Xbox_Cover.png/revision/latest?cb=20150331162657','PS2 GC Xbox'),
	('S18_3140','God of War','Sony','Moderate scratches but working.  Not historically accurate.',3913,68.30,'https://r.mprd.se/fup/up/150565-God_of_War_(USA)-1.jpg','PS2 GC Xbox'),
	('S18_3259','Zelda: Wind Waker','Nintendo','Excellent condition.  Comes with Ocarina of Time Master Quest Disc for Gamecube.',6450,67.56,'https://images-na.ssl-images-amazon.com/images/I/51W8C95QDDL.jpg','PS2 GC Xbox'),
	('S18_3782','Star Wars: Knights of the Old Republic','Microsoft','Platinum edition.  One side of disc is dark.',7689,32.95,'https://images-na.ssl-images-amazon.com/images/I/512W2830SFL.jpg','PS2 GC Xbox'),
	('S18_4600','Resident Evil','Nintendo','For collectors only.  NOT PLAYABLE.  Game has suffered burns and can not come back to life.',3128,84.76,'https://gamefaqs.akamaized.net/box/6/2/7/6627_front.jpg','PS2 GC Xbox'),
	('S24_1578','Playstation 2','Sony','All original parts included.  Also plays DVDs!!',7003,60.86,'https://cdn3.volusion.com/gxcae.edrcf/v/vspfiles/photos/1454-2.jpg','PS2 GC Xbox'),
	('S24_1785','Xbox 360 slim - 20GB','Microsoft','All cables included.  2 controllers.  New Low Price!',3627,66.74,'https://static-ca.ebgames.ca/images/products/700546/3max.jpg','PS3 Xbox 360'),
	('S24_2000','Portal 2','Sony','Great Condition. Comes with Portal Gun',15,37.32,'https://images-na.ssl-images-amazon.com/images/I/51Vgt4pMFTL._SX342_.jpg','PS3 Xbox 360'),
	('S24_2011','Playstation 3 - 60GB','Sony','Solid Condition.  Comes with The Last of Us',1898,82.34,'https://media.playstation.com/is/image/SCEA/system-update-ps3-main-02-us-03nov14?$TwoColumn_Image$','PS3 Xbox 360'),
	('S24_2300','Fallout 3','Sony','Lowest Price Around! Buy now and save a megaTON of money',2327,61.34,'https://www.gamestop.com/common/images/lbox/270121b.jpg','PS3 Xbox 360'),
	('S24_2360','Gears of War 3','Microsoft','Blast Locusts for a Low Cost! Comes with Cole Train action figure.  Good condition.',6840,47.10,'http://www.codefoster.com/files/gow3_01.jpg','PS3 Xbox 360'),
	('S24_2841','Mass Effect Trilogy','Microsoft','All 3 games in great condition.  A decent ending is not included.',5942,34.25,'https://images-na.ssl-images-amazon.com/images/I/71MSQ1p3l3L._AC_SX215_.jpg','PS3 Xbox 360'),
	('S24_3949','Red Dead Redemption','Microsoft','Minor scratches ',6812,29.34,'https://www.gamestop.com/common/images/lbox/200689b2.jpg','PS3 Xbox 360'),
	('S24_4278','Batman: Arkham City','Microsoft','Great Condition.',2756,36.23,'http://cdn1-www.superherohype.com/assets/uploads/2011/06/file_167589_0_arkhamcitycover1.jpg','PS3 Xbox 360'),
	('S32_1268','Zelda: Ocarina of Time','Nintendo','Gold cartridge.  Fantastic Condition',5099,53.93,'http://www.gamerscoup.com/nintendo/n64/boxart/zeldaoot.png','Nintendo 64'),
	('S32_1374','GoldenEye 007','Nintendo','Good condition.',178,66.92,'https://upload.wikimedia.org/wikipedia/en/3/36/GoldenEye007box.jpg','Nintendo 64'),
	('S32_2509','Jet Force Gemini','Nintendo','Working Condition',2874,25.98,'https://upload.wikimedia.org/wikipedia/en/1/1a/Jet_Force_Gemini_box.jpg','Nintendo 64'),
	('S32_3207','Mario Kart 64','Nintendo','Minor Scratches.  Rainbow Road course may cause seizures',8601,26.72,'https://www.mariowiki.com/images/thumb/5/5f/MK64_Cover.png/300px-MK64_Cover.png','Nintendo 64'),
	('S32_3522','Star Wars: Shadows of the Empire','Nintendo','No instruction manual',814,33.61,'https://vignette.wikia.nocookie.net/starwars/images/3/3a/SOTE-N64.png/revision/latest?cb=20130611052056','Nintendo 64'),
	('S50_1514','Star Wars: Rogue Squadron','Nintendo','Brand new never opened',1645,37.49,'https://vignette.wikia.nocookie.net/nintendo/images/a/a7/Star_Wars_Rogue_Squadron_%28Players_Choice%29_%28NA%29.jpg/revision/latest?cb=20071214123832&path-prefix=en','Nintendo 64'),
	('S700_1138','Crash Bandicoot','Sony','Not in original cover.',1897,34.00,'https://i.ebayimg.com/images/g/aCIAAOSwrtVZrDz2/s-l225.jpg','PS1'),
	('S700_1691','Grandia','Sony','Brand new in box',5841,51.15,'https://www.lukiegames.com/assets/images/PS1/ps1_grandia_p_4ib5em.jpg','PS1'),
	('S700_1938','Playstation Console','Sony','Comes with all cables, 1 controller, 2 memory cards.',737,43.30,'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/PSX-Console-wController.jpg/1200px-PSX-Console-wController.jpg','PS1'),
	('S700_2047','Mega Man X4','Sony','Amazing Condition.  Zero Flaws',3501,39.83,'https://romsmania.com/statics/assets/covers/playstation/895px-mmx4psuscovers-105028.jpg','PS1'),
	('S700_2466','Twisted Metal 2','Sony','Works good with minor bugs.  Cars freeze from time to time.',9653,68.80,'https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/Twisted_Metal_2.jpg/252px-Twisted_Metal_2.jpg','PS1'),
	('S700_2610','Pacman','Nintendo','Good Condition. Minor scratches',7083,33.97,'https://images-na.ssl-images-amazon.com/images/I/51sCtVUvA2L.jpg','NES'),
	('S700_2834','NES Console','Nintendo','All cables included.  Still Works',7106,59.33,'https://cdn.shopify.com/s/files/1/1353/3275/products/199644800px-NES-console-with-controller-png_2048x2048.png?v=1490888801','NES'),
	('S700_3505','Nintendo Gamecube','Nintendo','All original parts in box plus a FREE Wavebird wireless controller.  Purple console.',1956,51.09,'https://images-na.ssl-images-amazon.com/images/I/61cc-278k0L._SX522_.jpg','PS2 GC Xbox'),
	('S700_3962','Microsoft Xbox','Microsoft','Xbox original? Xbox 1? Xbox one part 1? This is the one with the big remotes.  Good condition.',5088,53.63,'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Xbox-console.jpg/1200px-Xbox-console.jpg','PS2 GC Xbox'),
	('S72_1253','Super Smash Bros.','Nintendo','Working with minor glitches.  Only hands are visible on the final boss.',4857,32.77,'https://vignette.wikia.nocookie.net/mario/images/a/a8/Super_Smash_Bros._-_North_American_Boxart.png/revision/latest?cb=20120303171118','Nintendo 64'),
	('S72_3212','Cruis\'n USA','Nintendo','Excellent Condition',414,33.30,'https://upload.wikimedia.org/wikipedia/en/b/b0/Cruis%27n_USA_for_N64%2C_Front_Cover.jpg','Nintendo 64');
...
INSERT INTO `users` (`id`, `cid`, `type`, `password`, `created`, `token`, `email`)
VALUES
	(1,498,'customer','$2a$10$qqCgQJPlCbzp81xXbHEiFe.GARg.cBcF9se7FQ4OWxj/zd5EI5FAi','2017-12-14 13:54:02','CTGcfgyRVMyW9hS2niftkUyMUlRlpx7IK49NJ6zWmOH9Y1ISTOq4RV8LUFfR3Q9KDuisPZGkJTqoCtHKdxqSftj0LbH68YbIeNJA','amir@amir.com');
